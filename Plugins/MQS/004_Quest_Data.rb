module QuestModule
  ...
  StoneFacedScience = {
    :ID => "15",
    :Name => "Stone-Faced Science",
    :QuestGiver => "Torin",
    :Stage1 => "Find three Strange Stones.",
    :Stage2 => "Return to the researcher.",
    :Stage3 => "Find five more Strange Stones.",
    :Stage4 => "D",
    :Stage5 => "E",
    :Stage6 => "F",
    :Stage7 => "G",
    ...
    :Stage11 => "K",
    :Stage12 => "L",
    :Location1 => "Madera, Madera Forest, Verdant Forest",
    :Location2 => "Madera Town",
    :Location3 => "Not Implimented yet.",
    :QuestDescription => "A researcher named Torin is investigating a statue that gives off faint Proto Energy readings.",
    :RewardString => "???"
  }

  LittleGirlsRequest = {
    :ID => "16",
    :Name => "Little Girl's Request",
    :QuestGiver => "Anna",
    :Stage1 => "Catch and give a Oddish to Anna.",
    :Location1 => "Betula Town",
    :QuestDescription => "Anna want's a cute Oddish from Verdant Forest.",
    :RewardString => "Super Special Item"
}
end
